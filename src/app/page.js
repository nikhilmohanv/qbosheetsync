            ...
            <div className=" items-center pt-30">
              <div className="flex flex-col gap-6">
                ...
                <p className="text-xl text-muted-foreground">
                  Automatically sync your QuickBooks data with Google Sheets for
                  powerful reporting, analysis, and collaboration.
                </p>
              ...
              {/* <div className="relative">
                <div className="relative rounded-lg overflow-hidden border shadow-xl">
                  <Image
                    ...
                    width={800}
                    height={600}
                    alt="QBOSyncSheet dashboard showing QuickBooks data in Google Sheets"
                    className="w-full"
                  />
                </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center gap-4 text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-[800px]">
                Everything you need to connect QuickBooks and Google Sheets for
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              <div className="flex flex-col gap-4 p-6 bg-card rounded-lg border shadow-sm">
                ...
                <p className="text-muted-foreground">
                  Set up automatic syncing between QuickBooks and Google Sheets
              ...
              <div className="flex flex-col gap-4 p-6 bg-card rounded-lg border shadow-sm">
                ...
                <p className="text-muted-foreground">
                  Create custom reports and dashboards using your QuickBooks
              ...
              {/* <div className="flex flex-col gap-4 p-6 bg-card rounded-lg border shadow-sm">
                ...
                <p className="text-muted-foreground">
                  Get real-time updates when your QuickBooks data changes with
                  instant syncing.
                </p>
              </div> */}
              ...
              <div className="flex flex-col gap-4 p-6 bg-card rounded-lg border shadow-sm">
                ...
                <p className="text-muted-foreground">
                  Import and analyze historical QuickBooks data to identify
              ...
              {/* <div className="flex flex-col gap-4 p-6 bg-card rounded-lg border shadow-sm">
                ...
                <p className="text-muted-foreground">
                  Access our library of pre-built templates for common financial
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-12 md:grid-cols-3">
              <div className="flex flex-col items-center gap-4 text-center">
                ...
                <p className="text-muted-foreground">
                  Securely connect your QuickBooks account and Google Sheets
                  with our easy setup wizard.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center gap-4 text-center">
                ...
                <p className="text-muted-foreground">
                  Choose which QuickBooks data you want to sync to Google Sheets
                  and how often.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center gap-4 text-center">
                ...
                <p className="text-muted-foreground">
                  Use Google Sheets to analyze your data, create reports, and
            ...
            {/* <div className="mt-16 flex justify-center">
              <div className="relative rounded-lg overflow-hidden border shadow-xl max-w-3xl">
                <Image
                  ...
                  width={800}
                  height={400}
                  alt="QBOSyncSheet workflow demonstration"
                  className="w-full"
                />
              </div>
            </div> */}
        ...
        {/* <section id="testimonials" className="py-20 md:py-28 bg-muted/40">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center gap-4 text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-[800px]">
                Hear from businesses that have transformed their financial
                reporting with QBOSyncSheet.
              </p>
            </div>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {[
                {
                  quote:
                    "QBOSyncSheet has saved our accounting team hours every week. We can now generate custom reports in minutes instead of days.",
                ...
                {
                  quote:
                    "As a small business owner, I needed an affordable way to get better insights from my QuickBooks data. QBOSyncSheet delivered exactly what I needed.",
                ...
                {
                  quote:
                    "We've been able to give our investors much more detailed financial reports since implementing QBOSyncSheet.",
                  author: "James Wilson",
                ...
                <div
                  key={i}
                  className="flex flex-col gap-4 p-6 bg-card rounded-lg border shadow-sm"
                >
        ...
        <section className="py-20 md:py-28">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center gap-4 text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-[800px]">
                Find answers to common questions about QBOSyncSheet.
              </p>
            </div>
            ...
            <div className="grid gap-6 max-w-3xl mx-auto">
              {[
                // {
                //   question: "Is QBOSyncSheet secure?",
                //   answer:
                //     "Yes, QBOSyncSheet uses bank-level encryption and never stores your QuickBooks credentials. We use OAuth for secure authentication and all data transfers are encrypted.",
                // },
                {
                  question: "Which versions of QuickBooks are supported?",
                  answer:
                    "QBOSyncSheet supports QuickBooks Online and QuickBooks Desktop (via QuickBooks Online Accountant). We currently don't support QuickBooks Self-Employed.",
                },
                {
                  question: "How often does the data sync?",
                  answer:
                    "Data can sync hourly, or daily. You can also manually trigger a sync anytime.",
                },
                {
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center gap-6 text-center max-w-3xl mx-auto">
              ...
              <p className="text-xl opacity-90 max-w-[800px]">
                Join QBOSyncSheet to connect QuickBooks and Google Sheets.
              </p>
        ...
        <div className="container px-4 md:px-6 py-12">
          ...
          {/* <div className="mt-12 pt-8 border-t">
            <div className="flex flex-col md:flex-row justify-between gap-4">
              <p className="text-sm text-muted-foreground">
                &copy; {new Date().getFullYear()} QBOSyncSheet. All rights
                reserved.
              </p>
              <div className="flex gap-4">
                <Link
